...
const TOPIC_KEYWORDS = {
    ...
    'Lead':            ['lead exposure', 'lead poisoning', 'blood lead', "lead"],
    'Radon':           ['radon'],
    'Wildfire Smoke':  ['wildfire', 'wildfire smoke', 'smoke exposure', "smoke", "fire"],
    'Heat Transfer':   ['candle', 'heat transfer', 'cooling', 'thermal', 'convection', 'temperature'],
    'Indoor':          ['indoor', 'classroom', 'apartment', 'kitchen', 'office'],
    'Traffic':         ['traffic', 'roadway', 'highway', 'commute', 'vehicle'],
    'Cooking':         ['cooking', 'cook', 'stove', "kitchen"],
